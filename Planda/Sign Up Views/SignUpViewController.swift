...
UITextFieldDelegate {
    ...
    func setupFirstNameTF() {
        ...
        firstNameTF.selectedLineColor = .white
        firstNameTF.selectedTitleColor = .white
        firstNameTF.tintColor = .white
        firstNameTF.titleColor = .white
        firstNameTF.lineColor = .white
        firstNameTF.textColor = .white
        firstNameTF.disabledColor = .white
    ...
    func setupLastNameTF() {
        ...
        lastNameTF.selectedLineColor = .white
        lastNameTF.selectedTitleColor = .white
        lastNameTF.tintColor = .white
        lastNameTF.titleColor = .white
        lastNameTF.lineColor = .white
        lastNameTF.textColor = .white
        lastNameTF.disabledColor = .white
    ...
    func setupBirthdateTF() {
        ...
        birthdateTF.selectedLineColor = .white
        birthdateTF.selectedTitleColor = .white
        birthdateTF.titleColor = .white
        birthdateTF.lineColor = .white
        birthdateTF.textColor = .white
        birthdateTF.disabledColor = .white
        birthdateTF.tintColor = .white
    ...
    func setupNextBtn() {
        ...
        nextBtn.setTitleColor(plandaColor, for: .init())
        nextBtn.setBackgroundColor(UIColor.white)
