...
//                            }
    ...
    func setupTextFields() {
        ...
        whenDepartureTF.selectedLineColor = UIColor.black
        whenDepartureTF.selectedTitleColor = UIColor.black
        whenDepartureTF.tintColor = UIColor.black
        whenDepartureTF.titleColor = UIColor.black
        whenDepartureTF.lineColor = UIColor.black
        whenDepartureTF.textColor = UIColor.black
        whenDepartureTF.disabledColor = UIColor.black
        whenDepartureTF.font = .systemFont(ofSize: 20)
        whenDepartureTF.delegate = self
        whenDepartureTF.attributedPlaceholder = NSAttributedString(string: "Departure", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        ...
        whenArrivalTF.selectedLineColor = UIColor.black
        whenArrivalTF.selectedTitleColor = UIColor.black
        whenArrivalTF.tintColor = UIColor.black
        whenArrivalTF.titleColor = UIColor.black
        whenArrivalTF.lineColor = UIColor.black
        whenArrivalTF.textColor = UIColor.black
        whenArrivalTF.disabledColor = UIColor.black
        whenArrivalTF.font = .systemFont(ofSize: 20)
        whenArrivalTF.delegate = self
        whenArrivalTF.attributedPlaceholder = NSAttributedString(string: "Arrival", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        ...
        howManyTF.selectedLineColor = UIColor.black
        howManyTF.selectedTitleColor = UIColor.black
        howManyTF.tintColor = UIColor.black
        howManyTF.titleColor = UIColor.black
        howManyTF.lineColor = UIColor.black
        howManyTF.textColor = UIColor.black
        howManyTF.disabledColor = UIColor.black
        howManyTF.font = .systemFont(ofSize: 20)
        howManyTF.delegate = self
        howManyTF.attributedPlaceholder = NSAttributedString(string: "Travellers", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        ...
        flightClassTF.selectedLineColor = UIColor.black
        flightClassTF.selectedTitleColor = UIColor.black
        flightClassTF.tintColor = UIColor.black
        flightClassTF.titleColor = UIColor.black
        flightClassTF.lineColor = UIColor.black
        flightClassTF.textColor = UIColor.black
        flightClassTF.disabledColor = UIColor.black
        flightClassTF.font = .systemFont(ofSize: 20)
        flightClassTF.delegate = self
        flightClassTF.attributedPlaceholder = NSAttributedString(string: "Class", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
    ...
    func setupStartPlanningBtn() {
        ...
        startPlanningBtn.setTitleColor(.black, for: .normal)
        startPlanningBtn.setBackgroundColor(.white)
...
//        destinationLabel.rightAnchor.constraint(equalTo: headerBackgroundImg.rightAnchor, constant: -20).isActive = true
    ...
    func tabBar(_ tabBar: MDCTabBar, didSelect item: UITabBarItem) {
        ...
        if (item.title == "Stays"){
            ...
            howManyTF.isHidden = false
            flightClassTF.isHidden = false
            whenDepartureTF.attributedPlaceholder = NSAttributedString(string: "Check In", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
            whenArrivalTF.attributedPlaceholder = NSAttributedString(string: "Check Out", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
            howManyTF.attributedPlaceholder = NSAttributedString(string: "Guests", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
            flightClassTF.attributedPlaceholder = NSAttributedString(string: "Rooms", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        }
