...
LoginButtonDelegate {
    ...
    func setupSignupBtn(){
        ...
        signupBtn.setTitleColor(.white, for: .init())
        signupBtn.setBackgroundColor(.black)
...
//        self.view.addSubview(agreementText)
    ...
    func setupConstraints() {
        ...
        plandaLogo.translatesAutoresizingMaskIntoConstraints = false
        plandaLogo.topAnchor.constraint(equalTo: view.topAnchor, constant: 100).isActive = true
        plandaLogo.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20).isActive = true
        plandaLogo.heightAnchor.constraint(equalToConstant: 45).isActive = true
        plandaLogo.widthAnchor.constraint(equalToConstant: 45).isActive = true
        
        /// Welcome message constraints
        welcomeText.translatesAutoresizingMaskIntoConstraints = false
        welcomeText.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 20).isActive = true
        welcomeText.topAnchor.constraint(equalTo: plandaLogo.bottomAnchor, constant: 30).isActive = true
...
//        agreementText.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -20).isActive = true
        ...
        signupBtn.bottomAnchor.constraint(equalTo: fbLoginBtn.topAnchor, constant: -20).isActive = true
        ...
        fbLoginBtn.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -50).isActive = true
